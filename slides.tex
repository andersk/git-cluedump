...
\begin{frame}
  ...
  \begin{itemize}
  \item The reflog tracks changes refs. Whenever a ref is updated to
    point at a new commit, it gets an entry in the reflog.
  \item If you find yourself somewhere you don't expect, you can
    examine the reflog, and then use \texttt{reset} to get back to a
    known point.
...
5360c2d... andersk@{0}: commit: 5½ is a better number.
